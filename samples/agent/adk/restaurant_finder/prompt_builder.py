...
def get_ui_prompt(base_url: str, examples: str) -> str:
    ...
    5.  **Always** include a `GoogleMap` component IMMEDIATELY AFTER the title in the response. For the map, provide lat, lng, and zoom that would show all the restaurants in the viewport, and pinAddresses based on the restaurant data you have already received from the `get_restaurants` tool.
...
def get_text_prompt() -> str:
    ...
    2.  **For getting directions (when you receive a query like 'USER_WANTS_TO_GET_DIRECTIONS...'):**

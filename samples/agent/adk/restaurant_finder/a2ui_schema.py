                ...
                "properties": {
                  "GoogleMap": {
                    ...
                    "properties": {
                      "lat": {
                        "type": "number",
                        "description": "The latitude to center the map instance on"
                      },
                      "lng": {
                        "type": "number",
                        "description": "The longitude to center the map instance on"
                      },
                      "zoom": {
                        "type": "number",
                        "description": "The zoom to initialize the map with the map instance on. Must be between 0 and 22"
                      },
                      "pinAddresses": {
                        "type": "array",
                        "description": "The addresses to pin on the map.",
                        "items": {
                          "type": "object",
                          "properties": {
                            "address": {
                              "type": "string",
                              "description": "The address of the place to pin on the map"
                            }
                          }
                        }
                      },
